...
![Topología completa de SmartCity Tech Park](./img/topologia_completa.png)

*Figura 1. Topología completa implementada en Cisco Packet Tracer.*
...
![VLANs configuradas en SW-CORE](./img/vlans_core.png)

*Figura 2. VLANs creadas en el servidor VTP `SW-CORE`.*
...
![VTP Server y EtherChannel en SW-CORE](./img/vtp_etherchannel_core.png)

*Figura 3. Estado VTP del servidor `SW-CORE`; en la misma evidencia se observan los Port-Channel LACP activos.*
...
![Enlaces troncales de SW-CORE](./img/trunks_core.png)

*Figura 4. Enlaces troncales 802.1Q del Core con VLAN nativa 94 y VLANs permitidas 14,24,34,44,54,94.*
...
![EtherChannel LACP en SW-CORE](./img/vtp_etherchannel_core.png)

*Figura 5. `Po1` y `Po2` activos mediante LACP; los puertos físicos aparecen agregados con estado `(P)`.*
...
#### Evidencia Root Bridge VLAN 24 – Investigación

![Root Bridge VLAN 24](./img/stp_vlan24_id.png)

*Figura 6. `SW-ID-DIST` como Root Bridge de la VLAN 24.*

#### Evidencia Root Bridge VLAN 34 – Producción

![Root Bridge VLAN 34](./img/stp_vlan34_produccion.png)

*Figura 7. `SW-PROD-DIST` como Root Bridge de la VLAN 34.*

#### Evidencia Root Bridge VLAN 14 – Gerencia

![Root Bridge VLAN 14](./img/stp_vlan14_corporativo.png)

*Figura 8. `SW-CORP-DIST` como Root Bridge de la VLAN 14.*

#### Evidencia Root Bridge VLAN 44 – Servidores

![Root Bridge VLAN 44](./img/stp_vlan44_core.png)

*Figura 9. `SW-CORE` como Root Bridge de la VLAN 44.*
...
![Prueba de conectividad I+D y aislamiento](./img/ping_id_aislamiento.png)

*Figura 10. Prueba exitosa dentro de la VLAN 24. En la misma captura se observa una prueba fallida hacia la VLAN 14, demostrando aislamiento inter-VLAN.*
...
![Prueba Producción y aislamiento](./img/ping_produccion_aislamiento.png)

*Figura 11. Comunicación exitosa dentro de la VLAN 34 a través del segmento Legacy; la misma captura muestra aislamiento frente a la VLAN 44.*
...
## 20. Evidencias gráficas incluidas

Las evidencias principales ya fueron integradas en las secciones correspondientes del documento. Los archivos se encuentran en la carpeta `img/`.

| Evidencia | Archivo |
|---|---|
| Topología completa | `img/topologia_completa.png` |
| VTP Server + EtherChannel | `img/vtp_etherchannel_core.png` |
| VLANs en SW-CORE | `img/vlans_core.png` |
| Trunks y VLAN nativa 94 | `img/trunks_core.png` |
| STP VLAN 24 | `img/stp_vlan24_id.png` |
| STP VLAN 34 | `img/stp_vlan34_produccion.png` |
| STP VLAN 14 | `img/stp_vlan14_corporativo.png` |
| STP VLAN 44 | `img/stp_vlan44_core.png` |
| Ping I+D + aislamiento | `img/ping_id_aislamiento.png` |
| Ping Producción + aislamiento | `img/ping_produccion_aislamiento.png` |

> La prueba de tolerancia a fallos de EtherChannel se documenta mediante la salida `Po1(SU) LACP Fa0/1(D) Fa0/2(P)` descrita en la sección 8.4. Si se obtiene una captura adicional de ese estado, puede agregarse como `img/etherchannel_falla.png`.
...
└── Proyecto 1/
    ...
    └── img/
        ...
        ├── vtp_etherchannel_core.png
        ├── vlans_core.png
        ├── trunks_core.png
        ├── stp_vlan24_id.png
        ├── stp_vlan34_produccion.png
        ├── stp_vlan14_corporativo.png
        ├── stp_vlan44_core.png
        ├── ping_id_aislamiento.png
        └── ping_produccion_aislamiento.png
```
